...
The reduction to a single primary case is defended in \autoref{3-subsec:3.1 research design}; what the chosen architecture cannot do however well it is executed is set out in \autoref{3-subsec:3.10 limitations}, and the remaining scope choices, together with the work they leave for others, are taken up in \autoref{5-subsec:5.5 future work}.
