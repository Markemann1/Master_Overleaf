...
The defence of these scope choices, and the limitations they impose, is deferred to the methodology (\autoref{3-subsec:3.10 limitations}) and the discussion (\autoref{5-subsec:5.5 future work}).
